...
const SmartFeatures = ({ data }) => {
    ...
    return (
        <section className="bg-[#F3F7FF] py-20">
            <div className="w-[85%] mx-auto flex gap-2.5 flex-wrap md:flex-nowrap px-6">

                {/* Top Row */}
                <div className="flex flex-wrap max-w-4xl  gap-[10vh] mb-14">
                    ...
                    <div className="flex flex-wrap  gap-8">
                        {rest.slice(0, 2).map((feature, index) => (
                            <motion.div
                                key={feature.id}
                                className="bg-white  flex flex-col justify-between  rounded-2xl shadow-md p-6"
                                initial={{ opacity: 0, y: 30 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                transition={{
                                    duration: 0.6,
                ...
                <div className="flex flex-col  justify-evenly ">
                    {/* <motion.div
                        className="bg-white rounded-2xl mx-auto  h-[400px] shadow-md w-md p-6"
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    {rest.slice(2).map((feature, index) => (
                        <motion.div
                            key={feature.id}
                            className="bg-white w-lg flex flex-col justify-between rounded-2xl shadow-md p-6"
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{
                                duration: 0.6,
                    ...
                    <img src={data.featuresSection.rightSideImage} className='w-full h-full object-cover' alt="" />
                </div>
