                    ...
                    <div className="grid relative md:grid-cols-2 gap-10 items-center">
   {
                        ...
                        <AnimatePresence  mode="wait">
                            ...
                            >
                                ...
                                <motion.button
                                    className="inline-flex items-center justify-center text-base sm:text-lg lg:text-xl px-6 sm:px-8 py-3 rounded-2xl font-bold  text-white bg-gradient-to-r from-[#3785FF] to-[#1146F2] border border-[#1146F2]   hover:opacity-90 hover:scale-105 hover:from-[#1146F2] to-[#3785FF] hover:shadow-2xl transition-all duration-300"
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
