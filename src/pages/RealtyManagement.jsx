                    ...
                    <div className="sm:w-[85%] card-padding mx-auto mt-14 md:mt-20">
                        ...
                        <div className="pb-16 bg-white">
                            <div className="">
                                ...
                                <div className="grid card-padding grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-20">
                ...
                >
                    <div className="container-main">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="grid grid-cols-1 relative  card-padding  md:grid-cols-2 lg:grid-cols-3 gap-10"
                        >
