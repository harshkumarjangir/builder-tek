    ...
    return (
        <section className="bg-[#F3F7FF] py-20 relative overflow-hidden">
            <div className="max-w-full mx-auto px-4 text-center relative">
                ...
                <button
                    className="testimonial-prev absolute left-6 md:left-10 top-1/2 -translate-y-1/2
          bg-blue-600 text-white text-3xl shadow-lg rounded-full
          w-11 h-11 flex items-center justify-center z-50 cursor-pointer"
                >
                    ‹
                </button>

                <button
                    className="testimonial-next absolute right-6 md:right-10 top-1/2 -translate-y-1/2
          bg-blue-600 text-white text-3xl shadow-lg rounded-full
          w-11 h-11 flex items-center justify-center z-50 cursor-pointer"
                >
                    ›
