        ...
        <nav className="bg-white shadow-sm sticky top-0 z-50">
            <div className="w-[85%] mx-auto">
                <div className="flex-between h-16 sm:h-20">
                    ...
                    {/* Desktop Menu */}
                    <div className="hidden lg:flex items-center space-x-6 xl:space-x-8 text-sm font-medium text-gray-800">
                    ...
                    >
                        <div className="container-main py-4">
                            <div className="flex flex-col space-y-4">
                                ...
                                <Link
                                    to={navData.cta.path}
                                    className="inline-flex items-center justify-center px-4 py-2 rounded-xl text-white bg-gradient-to-r from-[#3785FF] to-[#1146F2] border border-[#1146F2] shadow-[0_6px_16px_rgba(0,0,0,0.2),0_0_0_1px_#155BC9] text-sm mt-4 w-full transition-all duration-300 hover:scale-105"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                >
                                    {navData.cta.label}
                                </Link>
