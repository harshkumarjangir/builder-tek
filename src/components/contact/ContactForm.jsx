        ...
        <div className="w-full relative overflow-visible">
            <div className="max-w-xl xl:max-w-full mx-auto">
                <motion.div
                    ...
                    className="bg-white rounded-[2rem] shadow-[0_22px_70px_rgba(0,0,0,0.06)] p-6 md:p-8 lg:p-10 border border-gray-100 overflow-hidden"
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                <select
                                    ...
                                    className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] focus:bg-white focus:border-[#1868f0] focus:ring-4 focus:ring-blue-500/10 transition-all outline-none appearance-none text-gray-700 font-semibold md:text-base cursor-pointer"
                                >
                        ...
                        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] focus:bg-white focus:border-[#1868f0] focus:ring-4 focus:ring-blue-500/10 transition-all outline-none text-gray-700 font-semibold"
                                />
                            </div>
                            <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex gap-3 max-w-full">
                                    <div className="flex items-center gap-2 px-3 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] w-[80px] shrink-0 justify-center text-gray-600 font-bold hover:border-blue-300 transition-colors cursor-pointer group">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange}
                                        className="flex-1 min-w-0 px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] focus:bg-white focus:border-[#1868f0] focus:ring-4 focus:ring-blue-500/10 transition-all outline-none text-gray-700 font-semibold"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] focus:bg-white focus:border-[#1868f0] focus:ring-4 focus:ring-blue-500/10 transition-all outline-none appearance-none text-gray-700 font-semibold cursor-pointer"
                                    >
                        ...
                        <div className="space-y-3">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-[1rem] focus:bg-white focus:border-[#1868f0] focus:ring-4 focus:ring-blue-500/10 transition-all outline-none resize-none text-gray-700 font-semibold shadow-inner"
                            ></textarea>
                        </div>
                        ...
                        <p className="text-[13px] md:text-base text-center text-gray-400 mt-12 leading-relaxed max-w-2xl mx-auto font-medium opacity-80">
                            {renderFooter(footer)}
                        </p>
                    </form>
                </motion.div>
